...
#   This class compute the lenght of vectors of every output-class, to make the classification
...
#   Squash function is a activation-function for ensure that the activity-vector lenght of each capsule is between [0;1]
